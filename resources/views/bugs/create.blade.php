          ...
          <div>
              <ul class="w-1/2 space-y-5">
                  @foreach ($errors->all() as $error)
                      <li class="p-8 border-2 border-red-500 text-red-500 bg-red-200 rounded-lg">{{ $error }}</li>
                  @endforeach
              </ul>
          </div>
      @endif
      ...
      <div>
        <div class="border-b border-gray-900/10 pb-12 space-y-8">
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <select id="project" name="project" autocomplete="project-name" class="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" required>
          ...
          <div class="col-span-full">
            <label for="description" class="block text-sm font-medium leading-6 text-gray-900">Bug Description</label>
            <div class="mt-2">
          ...
          <div class="col-span-full">
            <label for="screenshot" class="block text-sm font-medium leading-6 text-gray-900">Bug Screenshot</label>
            <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
              <div class="text-center">
                ...
                <div class="mt-4 flex text-sm leading-6 text-gray-600">
                  <label for="screenshot" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                    <span>Upload a file</span>
                    <input id="screenshot" name="screenshot" type="file" class="sr-only" accept="image/*" required>
                  </label>
