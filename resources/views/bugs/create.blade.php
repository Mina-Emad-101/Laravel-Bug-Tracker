<x-layout>
    ...
    <x-main>
        <x-form action="/bugs" enctype="multipart/form-data" method="POST">
            ...
            <x-form-element name="description">
                <textarea id="description" name="description" rows="4" cols="70"
                    class="p-1.5 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
                    required></textarea>
            </x-form-element>
            ...
            <x-form-element name="screenshot">
                <div class="flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div class="text-center">
                        ...
                        <p class="text-xs leading-5 text-gray-600">Image Files Only</p>
                    </div>
                </div>
            </x-form-element>
